    ...
    <body> 
        <div class="container w-100 mw-100"><!-- container w-100 mw-100 -->
            ...
            <div class="topnav"><!-- topnav -->
                ...
                <div class="dropdown">
                    <button class="dropbtn">Programas <i class="fa fa-angle-down"></i></button>
                ...
                <div class="dropdown">
                    <button class="dropbtn">Contratacion <i class="fa fa-angle-down"></i></button>
                    <div class="dropdown-content">
            ...
            <div class="topnav2">
                <h1>Diagnóstico de competencias TIC / Profesores</h1>
		    </div>
                            ...
                            <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <tr>
                                            <td>Técnica Profesional en Operación y Logística de Empresas Agroindustriales</td>
                                        ...
                                        <tr>
                                            <td>Ingeniería de Sistemas y Telecomunicacioness</td>
                                        ...
                                        <tr>
                                            <td>Especialización en Edumática Innovación de los procesos educativos a través de herramientas multimediales</td>
                                        ...
                                        <tr>
                                            <td>Especialización en Desarrollo del Software</td>
                                        ...
                                        <tr>
                                            <td>Tecnólogo En Producción De Imagen Y Sonido</td>
