...
<html lang="en-EN">
    ...
    <style>
        ...
        .topnav .dropdown-content a:hover {background-color: #a974e3;}

        .topnav .dropdown:hover .dropdown-content {display: block;}

        .topnav .dropdown:hover .dropbtn {background-color: rgb(0, 143, 48);}
    ...
    <body> 
        <div class="container w-100 mw-100">
            ...
            <div class="topnav">
                ...
                <button type="submit" class="btn btn-light" name="B1"><a href="general2.php">Regresar</a></button>
                <div class="dropdown">
                    <button class="dropbtn">Facultades</button>
                    <div class="dropdown-content">
                        <ul style="list-style-type:none;">
                            <li><a href="#sec2">Fac. de Arquitectura y Diseño</a></li>
                            <li><a href="#sec3">Fac. de Ciencias Humanas, Sociales y de la Educación</a></li>
                            <li><a href="#sec3">Fac. de Ciencias Económicas y Administrativas</a></li>
                            <li><a href="#sec3">Fac. de Ciencias Básicas e Ingeniería</a></li>
                        </ul>
                    </div>
                </div>
                <div class="dropdown">
