    ...
    <body> 
	    ...
	    <header>
			...
			<div class="Titulo" style="text-align:center;">
				<h1 style="color:#ffffff;">	
					Facultad de Ciencias Económicas <br> y Administrativas
				</h1>
			</div> 
        </header> 
		<div class="dropdown2">
		...
		<div class="dropdown3">
  			...
  			<div class="dropdown-content3">
		          ...
		          <a href="1_Administracion/admemp.php">Administración de Empresas</a>
		          <a href="2_Negocios/negint.php">Negocios Internacionales</a>
		          <a href="3_Mercadeo/mer.php">Mercadeo</a>	
		          <a href="4_Tecnologia/tecgesmer.php">Tecnología en Gestión de Mercadeo</a>
				  <br>
				  <a style="font-weight: bold;">Posgrado</a>
		          <a href="5_Maestria/masmer.php">Maestría en Mercadeo</a>
		          <a href="6_Gestion/maegespro.php">Maestría en Gestión de Proyectos</a>
		          <a href="7_Regional/maegesdes.php">Maestría en Gestión del Desarrollo Regional</a>
		          <a href="8_Finanzas/maefin.php">Maestría en Finanzas</a>
		          <a href="9_Innovacion/maegesinn.php">Maestría en Gestión de la Innovación</a>
		          <a href="10_Especializacion/espfin.php">Especialización en Finanzas</a>
		          <a href="11_Ciberasesoria/espcibfin.php">Especialización en Ciberasesoría Financiera</a>
		          <a href="12_Publica/especo.php">Especialización en Economía Pública y Gestión Territorial</a>
  			</div>
		</div>
        <?php
	        $sem = $_POST['semestre'];
                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
								...
								<?php include "Datos_tablas/1_economia.php";?>
								<table border="1" style="margin: 0 auto;">
									...
									<tr>
										...
										<td><?php echo round(($data3['total2']/$data['total'])*100,2);?></td>
									</tr>
									<tr>
										<td>Mercadeo</td>
