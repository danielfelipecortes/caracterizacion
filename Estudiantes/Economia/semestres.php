                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
								...
								<?php include "Datos_tablas_sem/1_economia.php";?>
                    ...
                    <div id="demo2" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas_sem/2_conocimiento.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                    ...
                    <div id="demo7" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas_sem/3_guardar.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas_sem/4_contrastar.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                ...
                <section id="sec7">
                    ...
                    <div id="demo16" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <!--Tabla 84 -->
                                <?php include "Datos_tablas_sem/5_creatividad.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 85 -->
                                <?php include "Datos_tablas_sem/6_comunicacion.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 86 -->
                                <?php include "Datos_tablas_sem/7_investigacion.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 88 -->
                                <?php include "Datos_tablas_sem/9_ciudadania.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 89 -->
                                <?php include "Datos_tablas_sem/10_operaciones.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                    ...
                    <div id="demo17" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas_sem/11_can_vis.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas_sem/12_can_aud.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas_sem/13_can_kin.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
