    ...
    <body> 
	    ...
	    <header>
			<div class="salida" style="text-align:right;">
				...
				<a href="ciencias.php" style="font-size:160%;color:#ffffff;">
					Regresar &nbsp;
				</a>
			...
			<div class="Titulo" style="text-align:center;">
				<h1 style="color:#ffffff;">
					Facultad de Ciencias Básicas <br>e Ingeniería
				</h1>
			</div> 
        </header> 
		<div class="dropdown2">
  			...
  			<div class="dropdown-content2">
			  	<form action="ciencias.php" method="post">
		...
		<div class="dropdown3">
  			...
  			<div class="dropdown-content3">
				  ...
				  <a href="35_Ingenieria/ingsistel.php">Ingeniería de Sistemas y Telecomunicaciones</a>
		          <a href="36_Industrial/ingind.php">Ingeniería Industrial</a>
		          <a href="37_Tecnologia/tecdessof.php">Tecnología en Desarrollo de Software</a>
  			</div>
		</div>
        <?php
	        $sem = $_POST['semestre'];
                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
								...
								<?php include "Datos_tablas/1_ciencias.php";?>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <?php 	$tamaño = 5;
                                            ...
                                            include "Datos_tablas/0_consultas.php";
                                    ?>
                                    <?php include "Datos_tablas/tabla23_ha1.php";?>
                                    <table border="1" style="margin: 0 auto;">
                                        <tr>
