    ...
    <body> 
    	...
    	<?php error_reporting (0);?>
            <div class="topnav"><!-- topnav -->
                ...
                <button type="submit" class="btn btn-light" name="B1"><a href="tecprovid.php">Regresar</a></button>
                <div class="dropdown">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <form action="tecprovid.php" method="post">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <ul style="list-style-type:none;">
                            <li><a>Pregrado</a></li>
                                <ul style="list-style-type:none;">
                                    <li><a href="tecprovid.php">Técnica Profesional en Video, Disc-jockey y Sonido</a></li>
            ...
            <div class="topnav2">
                    <h1>Diagnóstico de competencias TIC / Estudiantes de<br>Técnica Profesional en Video, Disc-jockey y Sonido</h1>
            </div>
