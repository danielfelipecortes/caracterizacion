    ...
    <body> 
        <div class="container w-100 mw-100"><!-- container w-100 mw-100 -->
            ...
            <div class="topnav"><!-- topnav -->
                ...
                <button type="submit" class="btn btn-light" name="B1"><a href="arquitectura.php">Regresar</a></button>
                <div class="dropdown">
                    <button class="dropbtn">Facultades</button>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <form action="arquitectura.php" method="post">
                ...
                <div class="dropdown">
                    <button class="dropbtn">Programas</button>
                    <div class="dropdown-content">
                        <ul style="list-style-type:none;">
                            <li><a>Pregrado</a></li>
                                <ul style="list-style-type:none;">
                                    <li><a href="13_Video/tecprovid.php">Técnica Profesional en Video, Disc-jockey y Sonido</a></li>
                                    <li><a href="14_Arquitectura/arq.php">Arquitectura</a></li>
                                    <li><a href="15_Diseño/disind.php">Diseño Industrial</a></li>
                                </ul>
                            <li><a>Posgrado</a></li>
                                <ul style="list-style-type:none;">
                                    <li><a href="16_Gestion/espgespro.php">Especialización en Gestión de Proyectos e Innovación</a></li>
                                    <li><a href="17_Urbanismo/masarq.php">Maestría en Arquitectura y Urbanismo</a></li>
                                    <li><a href="18_Bioclimatica/esparq.php">Especialización en Arquitectura Bioclimática</a></li>
                                    <li><a href="19_Sostenible/espgescon.php">Especialización en Gestión de la Construcción Sostenible</a></li>
                                </ul>
                        </ul>
                    </div>
                </div>
            ...
            <div class="topnav2">
                    <h1>Diagnóstico de competencias TIC / Estudiantes de<br>la Facultad de Arquitectura y Diseño</h1>
            </div>
                                ...
                                <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <?php include "Datos_tablas/1_arquitectura.php";?>
