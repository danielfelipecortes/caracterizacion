  ...
  <body> 
    ...
    <header>
      <div class="salida" style="text-align:right;">
        ...
        <a href="esppsi.php" style="font-size:160%;color:#ffffff;">
          Regresar &nbsp;
        </a>
      ...
      <div class="Titulo" style="text-align:center;">
        <h1 style="color:#ffffff;">
            Especialización en esppsicología Clínica con énfasis en esppsicoterapia con niños y adolescentes
        </h1>
      </div> 
    </header> 
		<div class="dropdown2">
  		...
  		<div class="dropdown-content2">
			  	<form action="esppsi.php" method="post">
