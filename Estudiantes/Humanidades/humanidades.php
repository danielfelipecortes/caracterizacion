...
<html>
    ...
    <body> 
	    ...
	    <header>
			...
			<div class="Titulo" style="text-align:center;">
				<h1 style="color:#ffffff;">	
					Facultad de Ciencias Humanas, Sociales <br>y de la Educación
				</h1>
			</div> 
        </header> 
		<div class="dropdown2">
  			...
  			<div class="dropdown-content2">
			  	<form action="humanidades.php" method="post">
		...
		<div class="dropdown3">
  			<button class="dropbtn3">Programas</button>
  			<div class="dropdown-content3">
			  	<a style="font-weight: bold;">Pregrado</a>
				<a href="20_Psicologia/psi.php">Psicología</a>
		        <a href="21_Comunicacion/comsoc.php">Comunicación Social - Periodismo</a>
		        <a href="22_Religion/licedu.php">Licenciatura en Educación Religiosa</a>
				<br>
				<a style="font-weight: bold;">Posgrado</a>
				<a href="23_Doctorado/docedu.php">Doctorado en Educación en Desarrollo Humano</a>
		        <a href="24_Maestria/maeinnedu.php">Maestría en Innovación Educativa</a>
		        <a href="25_Estrategia/maeges.php">Maestría en Gestión Estratégica de la Comunicación</a>
		        <a href="26_Memoria/maemem.php">Maestría en Memoria y Escenarios Transicionales</a>
		        <a href="27_Pedagogia/maeped.php">Maestría en Pedagogía y Desarrollo Humano</a>
		        <a href="28_Cultura/maeest.php">Maestría en Estudios Culturales</a>
		        <a href="29_Humano/espped.php">Especialización en Pedagogía y Desarrollo Humano</a>
		        <a href="30_Edumatica/espedu.php">Especialización en Edumática Innovación Educativa Mediada por TIC</a>
		        <a href="31_Gerencia/espger.php">Especialización en Gerencia de la Comunicación Corporativa</a>
		        <a href="32_Clinica/esppsi.php">Especialización en Psicología Clínica con énfasis en Psicoterapia con niños y adolescentes</a>
		        <a href="33_Social/esppsisoc.php">Especialización en Psicología Social Comunitaria y Acción Psicosocial</a>
		        <a href="34_Organizacion/espges.php">Especialización en Gestión Humana en las Organizaciones</a>
  			</div>
		</div>
        <?php
	        $sem = $_POST['semestre'];
                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
								...
								<?php include "Datos_tablas/1_humanidades.php";?>
                    ...
                    <div id="demo2" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas/2_conocimiento.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                    ...
                    <div id="demo7" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas/3_guardar.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas/4_contrastar.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                ...
                <section id="sec7">
                    ...
                    <div id="demo16" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <!--Tabla 84 -->
                                <?php include "Datos_tablas/5_creatividad.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 85 -->
                                <?php include "Datos_tablas/6_comunicacion.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 86 -->
                                <?php include "Datos_tablas/7_investigacion.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 88 -->
                                <?php include "Datos_tablas/9_ciudadania.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                <!--Tabla 89 -->
                                <?php include "Datos_tablas/10_operaciones.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                    ...
                    <div id="demo17" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <?php include "Datos_tablas/11_can_vis.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas/12_can_aud.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
                            ...
                            <div class="carousel-item">
                                ...
                                <?php include "Datos_tablas/13_can_kin.php";?>
                                <table border="1" style="margin: 0 auto;">
                                    <tr>
