    ...
    <body> 
        <div class="container w-100 mw-100"><!-- container w-100 mw-100 -->
            ...
            <div class="topnav"><!-- topnav -->
                ...
                <div class="dropdown">
                    <button class="dropbtn">Facultades <i class="fa fa-angle-down"></i></button>
                    <div class="dropdown-content">
                        <ul style="list-style-type:none;">
                            <li><a href="Arquitectura/arquitectura.php">Fac. de Arquitectura y Diseño</a></li>
                            <li><a href="Humanidades/humanidades.php">Fac. de Ciencias Humanas, Sociales y de la Educación</a></li>
                            <li><a href="Economia/economia.php">Fac. de Ciencias Económicas y Administrativas</a></li>
                            <li><a href="Ciencias/ciencias.php">Fac. de Ciencias Básicas e Ingeniería</a></li>
                        </ul>
                    </div>
                </div>
                <div class="dropdown">
                ...
                <div class="dropdown">
                    <button class="dropbtn">Semestre <i class="fa fa-angle-down"></i></button>
                    <div class="dropdown-content">
            ...
            <div class="topnav2">
                <h1>Diagnóstico de competencias TIC / Estudiantes</h1>
		    </div>
                            ...
                            <div id="demo" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <!--Tabla 1 Inscritos por facultad-->
                                        <?php include "Datos_tablas/1_facultades.php";?>
                                        ...
                                        <div class="graf">
                                            <?php 
                                                ...
                                                $dato3=$data3['total3'];
                                                $dato4=$data4['total4'];
                                                $prueba = "UPDATE `grafica1` SET `rating` = $dato1 WHERE `grafica1`.`ID` = 1";
                                                $Ingreso = mysqli_query($cn,$prueba);
                                                $prueba2 = "UPDATE `grafica1` SET `rating` = $dato2 WHERE `grafica1`.`ID` = 2";
                                                $Ingreso2 = mysqli_query($cn,$prueba2);
                                                $prueba3 = "UPDATE `grafica1` SET `rating` = $dato3 WHERE `grafica1`.`ID` = 3";
                                                $Ingreso3 = mysqli_query($cn,$prueba3);
                                                $prueba4 = "UPDATE `grafica1` SET `rating` = $dato4 WHERE `grafica1`.`ID` = 4";
                                                $Ingreso4 = mysqli_query($cn,$prueba4);
                                            ?>
                                            <?php include ("Graficos/grafica1.php"); ?>
                                        </div>
                                        <div class="imprimir" id="imprimir" name="imprimir"><a href="../Estructura/Reportes/reporte1.php"><i class="fa fa-print"></i></a></div>
                                    </div>
                                    <div class="carousel-item">
                                        <!--Tabla 2 Inscritos por programa-->
                                        <?php include "Datos_tablas/2_economia.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                            ...
                                            <?php include "Datos_tablas/2_arquitectura.php";?>
                                            <tr>
                                            ...
                                            <?php include "Datos_tablas/2_humanidades.php";?>
                                            <tr>
                                            ...
                                            <?php include "Datos_tablas/2_ciencias.php";?>
                                            <tr>
                                        ...
                                        <!--Tabla 2 Inscritos por progrma-->
                                        <div class="imprimir" id="imprimir" name="imprimir"><a href="../Estructura/Reportes/reporte2.php"><i class="fa fa-print"></i></a></div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <div class="graf">
                                            <?php 
                                                ...
                                                $dato3=$data3['total3'];
                                                $dato4=$data4['total4'];
                                                $prueba = "UPDATE `grafica3` SET `rating` = $dato1 WHERE `grafica3`.`ID` = 1";
                                                $Ingreso = mysqli_query($cn,$prueba);
                                                $prueba2 = "UPDATE `grafica3` SET `rating` = $dato2 WHERE `grafica3`.`ID` = 2";
                                                $Ingreso2 = mysqli_query($cn,$prueba2);
                                                $prueba3 = "UPDATE `grafica3` SET `rating` = $dato3 WHERE `grafica3`.`ID` = 3";
                                                $Ingreso3 = mysqli_query($cn,$prueba3);
                                                $prueba4 = "UPDATE `grafica3` SET `rating` = $dato4 WHERE `grafica3`.`ID` = 4";
                                                $Ingreso4 = mysqli_query($cn,$prueba4);
                                            ?>
                                            <?php include ("Graficos/grafica3.php"); ?>
                                        </div>
                                        <div class="imprimir" id="imprimir" name="imprimir"><a href="../Estructura/Reportes/reporte3.php"><i class="fa fa-print"></i></a></div>
                                    </div>
                                    <div class="carousel-item">
                            ...
                            <div id="demo2" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <?php include "Datos_tablas/3_conocimiento.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                            ...
                            <div id="demo7" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <?php include "Datos_tablas/4_guardar.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <?php include "Datos_tablas/5_contrastar.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                        ...
                        <section id="sec7">
                            ...
                            <div id="demo16" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <!--Tabla 84 -->
                                        <?php include "Datos_tablas/6_creatividad.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        <!--Tabla 85 -->
                                        <?php include "Datos_tablas/7_comunicacion.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        <!--Tabla 86 -->
                                        <?php include "Datos_tablas/8_investigacion.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        <!--Tabla 87 -->
                                        <?php include "Datos_tablas/8_pensamiento.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        <!--Tabla 88 -->
                                        <?php include "Datos_tablas/10_ciudadania.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        <!--Tabla 89 -->
                                        <?php include "Datos_tablas/11_operaciones.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                            ...
                            <div id="demo17" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <?php include "Datos_tablas/12_can_vis.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <?php include "Datos_tablas/13_can_aud.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <?php include "Datos_tablas/14_can_kin.php";?>
                                        <table border="1" style="margin: 0 auto;">
                                            <tr>
